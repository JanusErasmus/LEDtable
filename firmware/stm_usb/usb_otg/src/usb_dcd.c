...
* @retval : status
*/
cyg_uint32 DCD_EP_Close(USB_OTG_CORE_HANDLE *pdev , cyg_uint8  ep_addr)
{
  USB_OTG_EP *ep;
...
* @retval : status
*/
cyg_uint32  DCD_EP_Stall (USB_OTG_CORE_HANDLE *pdev, cyg_uint8   epnum)
{
  USB_OTG_EP *ep;
  if ((0x80 & epnum) == 0x80)
  {
...
* @retval : status
*/
cyg_uint32  DCD_EP_ClrStall (USB_OTG_CORE_HANDLE *pdev, cyg_uint8 epnum)
{
  USB_OTG_EP *ep;
  if ((0x80 & epnum) == 0x80)
  {
...
* @retval : status
*/
cyg_uint32  DCD_EP_Flush (USB_OTG_CORE_HANDLE *pdev , cyg_uint8 epnum)
{
...
* @retval : status
*/
void  DCD_EP_SetAddress (USB_OTG_CORE_HANDLE *pdev, cyg_uint8 address)
{
...
cyg_uint32 DCD_GetEPStatus(USB_OTG_CORE_HANDLE *pdev ,cyg_uint8 epnum)
{
  USB_OTG_EP *ep;
  cyg_uint32 Status = 0;
...
* @retval : None
*/
void DCD_SetEPStatus (USB_OTG_CORE_HANDLE *pdev , cyg_uint8 epnum , cyg_uint32 Status)
{
  USB_OTG_EP *ep;
